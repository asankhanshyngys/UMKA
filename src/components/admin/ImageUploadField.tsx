  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {url && <button type="button" onClick={() => { setUrl(""); setStatus("Image removed. Save the form to apply this change."); }} className="rounded-lg px-3 py-2 text-sm text-red-700 hover:bg-red-50">Remove</button>}
      </div>
