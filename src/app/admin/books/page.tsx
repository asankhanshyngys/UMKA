...
export default async function BooksAdminPage() {
  const books = await prisma.book.findMany({ where: { deletedAt: null }, select: { id: true, title: true, author: true, description: true, price: true, status: true, storageKey: true, coverImageKey: true }, orderBy: { createdAt: "desc" } });
